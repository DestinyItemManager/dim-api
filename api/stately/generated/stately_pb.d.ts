...
import type { GenEnum, GenFile, GenMessage, ProtobufESMessage } from '@stately-cloud/client';
 ...
 */
export declare type ApiApp = ProtobufESMessage<'stately.generated.ApiApp'> & {
  /**
 ...
 *   * /gs-:stage
 */
export declare type GlobalSettings = ProtobufESMessage<'stately.generated.GlobalSettings'> & {
  stage: string;
  /**
 ...
 */
export declare type ItemAnnotation = ProtobufESMessage<'stately.generated.ItemAnnotation'> & {
  profileId: bigint;
 ...
 */
export declare type ItemHashTag = ProtobufESMessage<'stately.generated.ItemHashTag'> & {
  profileId: bigint;
  destinyVersion: number;
  tag: TagValue;
  notes: string;
 ...
 */
export declare type Loadout = ProtobufESMessage<'stately.generated.Loadout'> & {
  /**
 ...
 *   * /loadoutShare-:id
 */
export declare type LoadoutShare = ProtobufESMessage<'stately.generated.LoadoutShare'> & {
  /**
 ...
 */
export declare type Search = ProtobufESMessage<'stately.generated.Search'> & {
  /**
 ...
 */
export declare type Settings = ProtobufESMessage<'stately.generated.Settings'> & {
  memberId: bigint;
  /**
 ...
 */
export declare type Triumph = ProtobufESMessage<'stately.generated.Triumph'> & {
  recordHash: number;
  profileId: bigint;
  destinyVersion: number;
};
...
export declare type ArtifactUnlocks = ProtobufESMessage<'stately.generated.ArtifactUnlocks'> & {
  /**
...
export declare type CollapsedSection = ProtobufESMessage<'stately.generated.CollapsedSection'> & {
  key: string;
  /**
...
export declare type CustomStatDef = ProtobufESMessage<'stately.generated.CustomStatDef'> & {
  /**
...
export declare type CustomStatsEntry = ProtobufESMessage<'stately.generated.CustomStatsEntry'> & {
  classType: DestinyClass;
  customStats: number[];
};
...
export declare type CustomStatWeightsEntry =
  ProtobufESMessage<'stately.generated.CustomStatWeightsEntry'> & {
    statHash: number;
    weight: number;
  };
...
export declare type InGameLoadoutIdentifiers =
  ProtobufESMessage<'stately.generated.InGameLoadoutIdentifiers'> & {
    colorHash: number;
    iconHash: number;
    nameHash: number;
  };
...
export declare type LoadoutItem = ProtobufESMessage<'stately.generated.LoadoutItem'> & {
  /**
 ...
 */
export declare type LoadoutParameters = ProtobufESMessage<'stately.generated.LoadoutParameters'> & {
  /**
...
export declare type ModsByBucketEntry = ProtobufESMessage<'stately.generated.ModsByBucketEntry'> & {
  bucketHash: number;
  modHashes: number[];
};
...
export declare type SetBonusCount = ProtobufESMessage<'stately.generated.SetBonusCount'> & {
  /**
...
export declare type SocketOverride = ProtobufESMessage<'stately.generated.SocketOverride'> & {
  /**
 ...
 */
export declare type StatConstraint = ProtobufESMessage<'stately.generated.StatConstraint'> & {
  /**
...
export declare type StatConstraintsEntry =
  ProtobufESMessage<'stately.generated.StatConstraintsEntry'> & {
    classType: DestinyClass;
...
export enum ArmorStatCompare {
  ArmorStatCompare_Current = 0,
  ArmorStatCompare_Base = 1,
  ArmorStatCompare_BaseMasterwork = 2,
}

/**
 * Describes the enum stately.generated.ArmorStatCompare.
 */
export declare const ArmorStatCompareSchema: GenEnum<ArmorStatCompare>;
...
export enum OrnamentDisplay {
  /**
   * Always display the ornament's image.
   */
  OrnamentDisplay_All = 0,
  /**
   * Always display the base image.
   */
  OrnamentDisplay_None = 1,
}

/**
 * Describes the enum stately.generated.OrnamentDisplay.
 */
export declare const OrnamentDisplaySchema: GenEnum<OrnamentDisplay>;
