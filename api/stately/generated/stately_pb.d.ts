 ...
 */
export declare type ApiApp = Message<'stately.generated.stately.ApiApp'> & {
  /**
 ...
 *   * /gs-:stage
 */
export declare type GlobalSettings = Message<'stately.generated.stately.GlobalSettings'> & {
  stage: string;
  /**
 ...
 */
export declare type ItemAnnotation = Message<'stately.generated.stately.ItemAnnotation'> & {
  profileId: bigint;
 ...
 */
export declare type ItemHashTag = Message<'stately.generated.stately.ItemHashTag'> & {
  profileId: bigint;
 ...
 */
export declare type Loadout = Message<'stately.generated.stately.Loadout'> & {
  /**
 ...
 *   * /loadoutShare-:id
 */
export declare type LoadoutShare = Message<'stately.generated.stately.LoadoutShare'> & {
  /**
 ...
 */
export declare type Search = Message<'stately.generated.stately.Search'> & {
  /**
 ...
 */
export declare type Settings = Message<'stately.generated.stately.Settings'> & {
  memberId: bigint;
  /**
 ...
 */
export declare type Triumph = Message<'stately.generated.stately.Triumph'> & {
  recordHash: number;
...
export declare type ArtifactUnlocks = Message<'stately.generated.stately.ArtifactUnlocks'> & {
  /**
...
export declare type CollapsedSection = Message<'stately.generated.stately.CollapsedSection'> & {
  key: string;
  /**
...
export declare type CustomStatDef = Message<'stately.generated.stately.CustomStatDef'> & {
  /**
...
export declare type CustomStatWeightsEntry =
  Message<'stately.generated.stately.CustomStatWeightsEntry'> & {
    statHash: number;
...
export declare type CustomStatsEntry = Message<'stately.generated.stately.CustomStatsEntry'> & {
  classType: DestinyClass;
...
export declare type InGameLoadoutIdentifiers =
  Message<'stately.generated.stately.InGameLoadoutIdentifiers'> & {
    colorHash: number;
...
export declare type LoadoutItem = Message<'stately.generated.stately.LoadoutItem'> & {
  /**
 ...
 */
export declare type LoadoutParameters = Message<'stately.generated.stately.LoadoutParameters'> & {
  /**
...
export declare type ModsByBucketEntry = Message<'stately.generated.stately.ModsByBucketEntry'> & {
  bucketHash: number;
...
export declare type SocketOverride = Message<'stately.generated.stately.SocketOverride'> & {
  /**
 ...
 */
export declare type StatConstraint = Message<'stately.generated.stately.StatConstraint'> & {
  /**
...
export declare type StatConstraintsEntry =
  Message<'stately.generated.stately.StatConstraintsEntry'> & {
    classType: DestinyClass;
